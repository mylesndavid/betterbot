...
CRITICAL: You MUST call notify_user() to actually send the message — the user can't see your text responses, only tool calls reach them. Compose your message, then call notify_user(message). Only send ONE message per idle check-in.` : '';
